...
<div class="main">
    ...
    <?php
    $apicall = file_get_contents("https://imdb-api.com/en/API/MostPopularTVs/k_24d933uc");
    ...
    $crew=$list_item['crew'];
                ...
                <div class="show" onclick="location.href='title.php?id=<?php echo $id;?>'">
